                        ...
                        <div className="subscribe__boxes">
                            <div className="subscribe__box">
                                ...
                                <div className="subscribe__words">
                                    <h3 className="subscribe__words--title">The Easiest Way to Break</h3>
                                    <p className="subscribe__words--paragraph">But I must explain to you how all this mistaken idea of denouncing pleas and praising pain was bor</p>
                                </div>
                            </div>
                            <div className="subscribe__box">
                            ...
                            <div className="subscribe__box">
                                ...
                                <div className="subscribe__words">
                                    <h3 className="subscribe__words--title">Recent Favorites On Repeat</h3>
                                    <p className="subscribe__words--paragraph">But I must explain to you how all this mistaken idea of denouncing pleas and praising pain was bor</p>
                                </div>
                            </div>
                        </div>
