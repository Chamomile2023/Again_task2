        ...
        <div className="container">
          <div className="header_bottom__hero">
            <div className="header_bottom__logo">
              <NavLink to="/" className="header_bottom--logo">
                MiSto
              </NavLink>
            </div>
            <div
              className="header_bottom__close"
            ...
            <div className="header_bottom__ul">
              <ul className="header_bottom__list">
                <li className="header_bottom__list--item">
                  <NavLink to="/" className="header_bottom__list--link">
                    About Us
                  </NavLink>
                </li>
                <li className="header_bottom__list--item">
                  <NavLink to="/women" className="header_bottom__list--link">
                    Women
                  </NavLink>
                </li>
                <li className="header_bottom__list--item">
                  <NavLink to="/men" className="header_bottom__list--link">
                    Men
                  </NavLink>
                </li>
                <li className="header_bottom__list--item">
